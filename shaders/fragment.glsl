...
*/
   //float feature = pow( gl_Color.r, 1. );
   //float painting = gl_Color.y;

   //vec3 color = (1.-feature)*(painting*vec3(1,0,0)+(1.-painting)*vec3(0,0,0))+feature*(painting*vec3(1,1,1)+(1.-painting)*vec3(0,1,0));
