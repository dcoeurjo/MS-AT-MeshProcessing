...
namespace DDG
{
   ...
   class MeshIO
   {
      public:
         ...
         static void writeMesh( std::ostream& out, const Mesh& mesh );
         static void writeEdgeTube( std::ostream& out, const Mesh& mesh, const double radius, const int faces );
         static void writeEdgeCSV( std::ostream& out, const Mesh& mesh );
         static void writeEdgeStrips( std::string filename, const Mesh& mesh);
